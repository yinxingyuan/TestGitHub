...
namespace TestGitHub.Daos.DataSchema
{
	public class ProductDdlBuilder : DdlBuilder
	{
		public override string GetSqlCreateTable()
		{
			return @"CREATE TABLE Product(Id int IDENTITY(1,1) PRIMARY KEY NOT NULL,Number nvarchar(255),Description nvarchar(255),Name nvarchar(255),Description nvarchar(255),Owner_Id int,Entity_Status int)";
		}
